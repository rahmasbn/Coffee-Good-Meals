...
const getListPromo = () => {
  return new Promise((resolve, reject) => {
    ...
    const sqlGetList = `SELECT id, id_category, name, description, code, discount, image, R, X, XL, dine_in, take_away, home_delivery FROM promo
...
const getPromoDetail = (id) => {
  return new Promise((resolve, reject) => {
    const sqlGetList = `SELECT id, id_category, name, description, code, 
